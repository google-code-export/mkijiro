...
char LANG_COMMENT [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "コ-ド名:";
...
char LANG_ADDRP2 [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "□アドレス △コ-ド追加 SELECT  履歴(最近10件)  ";
char LANG_ADDALL [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "全結果をコ-ド追加";
char LANG_ADD [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "1つコ-ド追加 ";
char LANG_TABLETITLE [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "コ-ド追加    アドレス   值       bit  実行";
char LANG_TABLEP3 [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "○ 変更";
char LANG_TABLEP4 [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "× 変更";
char LANG_NEWADDR [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "コ-ド追加";

char LANG_SEARCH [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "検索:";

char LANG_NOTFOUND [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "サ-チ失敗   ";
...
//layout.c
char LAYOUT_READ_HELP [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "START リネ-ム,SEL 削除  ,□中国文字切替";
char LAYOUT_READTEXT_SAVEHELP [] __attribute__(   (  aligned( 1 ), section( ".data" )  )   ) = "START ラベル,SEL/△ 中断,LR スクロ-ル,○× 終了  ";
