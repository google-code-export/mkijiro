...
//èc8(í èÌ)=33,èc12=22,èc16=18ÅAèc19=16Å@ÇÆÇÁÇ¢
//Ç±ÇÍÇÊÇËëΩÇ≠Ç∑ÇÈÇ∆âÊñ îÕàÕäOÇ…èëÇ´Ç±ÇÒÇ≈âÊñ Ç™ÉoÉOÇËÇ‹Ç∑
#define MAX_SCREEN_Y 18
...
//â°8xèc8éû(MAX_SCREEN_Y-5-2-5)
#define MAX_MENU_NUMBER_PER_PAGE (MAX_SCREEN_Y-5-2-5+1)
