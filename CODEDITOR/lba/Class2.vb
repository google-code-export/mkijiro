...
Public Class checkupdate
    ...
    Public Sub CDEupater(ByVal mode As String)
        ...
        If My.Computer.Network.IsAvailable Then
            ...
            Dim b2 As String = StrConv(f.builddate.Text, VbStrConv.Narrow)
                ...
                If String.Compare(dd, rr, True) <= 0 Then
                    ...
                    If exeupdate = True Then
                        ...
                        If result = DialogResult.Yes Then
                            Dim txt As String = Application.StartupPath & "\tmp\updater.txt"
                            Dim boot As String = Application.StartupPath & "\tmp\updater.exe"
                            If My.Computer.FileSystem.DirectoryExists(Application.StartupPath & "\tmp") = False Then
