...
"mtvme", "0xb0000000", "0xFC000000", "%t,%i"}
    ...
    Function decode_arg(ByVal str As String, ByVal hex As UInteger, ByVal address As String) As String
        ...
        If str.Contains("%O") Then
            ...
            End If
            k = (k << 2) + 4
            k += (Convert.ToInt32(address, 16) And &HFFFFFFF)
            If k < &H1800000 Then
                k += &H8800000
            End If
